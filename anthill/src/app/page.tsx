...
function getPrimaryFile(manifestJson: string | null): string {
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <h1 className={styles.title}>
          <span className={styles.headerAccent}>Anthill</span>
        </h1>
      </header>
      ...
      <form className={styles.formCard} onSubmit={handleSubmit}>
        ...
        <div className={styles.field}>
          ...
          <textarea
            ...
            placeholder="A web app, a Python script, documentation, analysis — describe any task..."
            required
          />
        </div>
        <div className={styles.field}>
              ...
              {p.status === "done" && (
                <>
                  <a
                    ...
                    href={`/api/projects/${p.id}/output?file=${getPrimaryFile(p.fileManifest)}`}
                    target="_blank"
